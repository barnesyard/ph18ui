//Office items
import officeBkgd from './assets/svg/PHRoomOfficeBackground.svg'
import worldMap from './assets/svg/worldmap.svg'
import deathMask from './assets/svg/deathmask.svg'
import pigFaceMask from './assets/svg/pigfacemask.svg'
import purpleArt from './assets/svg/purpleart.svg'
import angelWings from './assets/svg/angelwings.svg'
import fourOclock from './assets/svg/fouroclock.svg'
import cookBook from './assets/svg/cookbook.svg'
import computer from './assets/svg/computer.svg'
import printer from './assets/svg/printer.svg'
import fortuneCookie from './assets/svg/fortunecookies.svg'
import globe from './assets/svg/globe.svg'
import goldBricks from './assets/svg/goldbricks.svg'
...
import hearNoEvil from './assets/svg/hearnoevil.svg'
import phone from './assets/svg/phone.svg'
import pillows from './assets/svg/pillows.svg'
import seeNoEvil from './assets/svg/seenoevil.svg'
...
import homewood from './assets/svg/homewood.svg'
...
import elvis from './assets/svg/elvis.svg'
import friends from './assets/svg/friends.svg'
import executioner from './assets/svg/theexecutioner.svg'
...
import brokenWindow from './assets/svg/brokenwindow.svg'
import chess from './assets/svg/chess.svg'
import comicBook from './assets/svg/comicbook.svg'
import dice from './assets/svg/dice.svg'
import exam from './assets/svg/exam.svg'
import handMirror from './assets/svg/handmirror.svg'
...
const viewData = [
  {
    ...
    "items": [
      ...
      },
      {
        "svg":goldBricks,
        "name": "goldBricks",
        "puzzleName": "The Rip Van Winkle Caper",
        "requiredItems": [],
        "top": "70%",
        "left": "58%",
        "width": "10%",
      },
      {
        "svg":soupBowl,
        "name": "soupBowl",
        "puzzleName": "Crazy as a Soup Sandwich",
        "requiredItems": [],
        "top": "63%",
        "left": "30%",
        "width": "5%",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        "svg":comicBook,
        "name": "comicBook",
        "puzzleName": "Azoth the Avenger Is a Friend of Mine",
        "requiredItems": [],
        "top": "67%",
        "left": "44%",
        "width": "13%",
      ...
      },
      {
        "svg":monster,
        "name": "monster",
        "puzzleName": "The Monsters Are On Maple Street",
        "requiredItems": [],
        "top": "30.5%",
        "left": "47.5%",
        "width": "5.5%",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        "svg":exit,
        "name": "exit",
        "puzzleName": "Five Characters in Search of an Exit",
        "requiredItems": [],
        "top": "2%",
        "left": "57%",
        "width": "10%",
      ...
      },
      {
        "svg":jacket,
        "name": "jacket",
        "puzzleName": "Black Leather Jackets",
        "requiredItems": [],
        "top": "41%",
        "left": "78%",
        "width": "18%",
  ...
  },
  {
    ...
    "items": [
      {
        "svg":entertainmentBkgd,
        "name": "entertainmentBackground",
        "puzzleName": "",
        "requiredItems": [],
        "top": "0%",
        "left": "0%",
      ...
      },
      {
        "svg":airplane,
        "name": "airplane",
        "puzzleName": "Nightmare at 20,000 Feet",
        "requiredItems": [],
        "top": "40%",
        "left": "72%",
        "width": "9%",
      ...
      },
      {
        "svg":friends,
        "name": "friends",
        "puzzleName": "What Are Friends For?",
        "requiredItems": [],
        "top": "25.5%",
        "left": "64%",
        "width": "5%",
      ...
      },
      {
        "svg":phonograph,
        "name": "phonograph",
        "puzzleName": "Song of the Younger World",
        "requiredItems": [],
        "top": "85%",
        "left": "7%",
        "width": "11%",
      },
      {
        "svg":rug,
        "name": "rug",
        "puzzleName": "Time Enough at Last",
        "requiredItems": [],
        "top": "83%",
        "left": "16%",
        "width": "60%",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        "svg":glasses,
        "name": "glasses",
        "puzzleName": "To See the Invisible Man",
        "requiredItems": [],
        "top": "57.5%",
        "left": "62%",
        "width": "5%",
      },
      {
        "svg":hearNoEvil,
        "name": "hearNoEvil",
        "puzzleName": "Voices in the Earth",
        "requiredItems": [],
        "top": "29%",
        "left": "76.2%",
        "width": "8%",
